...
export default withLightbox(({openLightbox}) => {
    return (<div>
        <ArticleTitle title="Koča Merjasec na Voglu – Koča na planini Razor" date="Neděle 1. 7."/>
        ...
        <p>Po svačině a pár fotkách už zamíříme dolů k chatě na Planině Razor, kde strávíme další noc. Šárinka vypije asi 3 litry čaje a Míša jen o něco míň piva. Od našich nových amerických kamarádů se dozvídáme o horolezeckém svazu Slovinska, díky kterému je možné získat velké slevy na ubytování, a za 50 EUR se stáváme členy. Konečně z nás jsou správní horalové. <Smile/></p>
