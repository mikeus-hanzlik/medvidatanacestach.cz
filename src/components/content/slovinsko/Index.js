...
export default withLightbox(({openLightbox}) => {
    return (<div>
        ...
        <figure>
            <img height={500} alt={trasa.caption} src={trasa.src} onClick={openLightbox(0)}/>
            <figcaption>{trasa.caption} (<a href="https://mapy.cz/s/2P5b6" rel="noopener noreferrer" target="_blank">mapa zde</a>)</figcaption>
        </figure>
    </div>)
}, [trasa])