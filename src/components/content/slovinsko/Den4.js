...
export default withLightbox(({openLightbox}) => {
    return (<div>
        ...
        <p>Ráno musíme vyklidit pokoje do 8:00, což znamená celkem brzké vstávání, snídaně, obligátní kloktání a po osmé už vyrážíme směrem dál údolím Triglavských jezer. Je pod mrakem, ale chvilkama i malinko prosvítá sluníčko. Opět se neustále předbíháme s Američany, nakonec jim ale utečeme. Necháváme chatu a první jezírka za námi, načež vystoupáme až nad jezero V Ledvicah, které nám pomalu vyrazí dech. Rozprostírá se pod námi, je krásné, velké, průzračné a zrcadlí se v něm obloha. I když není úplné vedro, neodoláme, slezeme srázem dolů ke břehu a skočíme se vykoupat. Sprchu tu na chatách asi jen tak nepotkáme a nějaká hygiena se hodí. Brzy nás následují i ostatní, kteří nás ze shora pozorují. Koupají se i starší Kanaďanky a naši Američani.</p>
        <figure>
        ...
        <figure>
            <img height={350} src={img3.src} alt={img3.caption} onClick={openLightbox(2)} />
        ...
        <figure>
            <img height={350} src={img4.src} alt={img4.caption} onClick={openLightbox(3)} />
